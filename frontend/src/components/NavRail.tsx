...
function SettingsIcon({ active }: { active: boolean }) {
  ...
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      ...
      <path d="M9 1.5v2M9 14.5v2M3.5 9h-2M16.5 9h-2M5.05 5.05l-1.42-1.42M14.37 14.37l-1.42-1.42M12.95 5.05l1.42-1.42M3.63 14.37l1.42-1.42" stroke={c} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
